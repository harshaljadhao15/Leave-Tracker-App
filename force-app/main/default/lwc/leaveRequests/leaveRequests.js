...
export default class LeaveRequests extends LightningElement {
    ...
    wiredMyLeaves(result){
        this.leaveRequestsWiredResult = result;
        if(result.data){
        ...
        if(result.error) {
            console.log('Error occured while fetching leaveRequests ', result.error);
        }
    }
    ...
    @api
    refreshGrid() {
        refreshApex(this.leaveRequestsWiredResult);
    }
